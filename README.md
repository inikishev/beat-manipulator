...
Advanced beat swapping powered by [madmom](https://github.com/CPJKU/madmom). Effortlessly make "every other beat is missing" remixes, or completely change beat of the song with patterns as complex you want. Additional remixing features include putting samples and fake sidechain on each beat, a plethora of audio effects, ability to turn audio to image and back to audio, various image effects, a custom BPM / shift analyzer and more.
